declare abstract class CacheAsbract implements CacheInterface {
    getMultiple<T>(keys: Array<string>, defaultValues?: Array<T> | undefined): Record<string, T>;
    setMultiple<T>(values: Record<string, T>, ttl?: number | undefined): boolean;
...
declare abstract class AsyncCacheAsbract implements CacheInterface {
    getMultiple<T>(keys: Array<string>, defaultValues?: Array<T> | undefined): Promise<Record<string, T>>;
    setMultiple<T>(values: Record<string, T>, ttl?: number | undefined): Promise<boolean>;
    deleteMultiple(keys: Array<string>): Promise<boolean>;
    abstract get<T>(key: string, defaultValue?: T): Promise<T | undefined>;
...
export { AsyncCacheAsbract as AsyncCacheAbsract, CacheAsbract, type CacheInterface as default };
